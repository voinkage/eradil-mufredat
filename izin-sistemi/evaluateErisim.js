 ...
 * @param {Array<{kapsam:string, referans_id:number|null, izin_verildi:boolean}>} rules
 * @param {{ rol: string, sinif_ids?: number[], sinif_id?: number|null, kullanici_id: number }} ctx
 */
...
/**
 * Aynı içerik birden fazla okulda tanımlı olabilir; öğrenci herhangi bir okulda yetkiliyse görebilir.
 * @param {Array<Record<string, unknown>>} rules — listRulesForOkullar çıktısı (filtrelenmiş veya tam)
 */
